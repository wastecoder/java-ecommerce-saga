...
/**
 * Blocking retry + dead-letter wiring for the {@code inventory.commands} consumer. Spring Boot auto-associates
...
public class KafkaErrorHandlingConfig {
	...
	DefaultErrorHandler kafkaErrorHandler(ProducerFactory<Object, Object> producerFactory) {
		...
		// A malformed command payload (ObjectMapper.convertValue) is deterministic — route straight to the DLT.
	 ...
	 * {@code KafkaTemplate}/{@code ProducerFactory} (which the publisher relies on) are preserved. It reuses
