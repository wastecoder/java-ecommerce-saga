...
class KafkaEnvelopeRoundTripIntegrationTest {
	...
	void publishAndConsume_roundTrips() throws InterruptedException {
		...
		assertThat(record).as("a record should be consumed from inventory.events").isNotNull();
	...
	static class TestListenerConfig {
		...
		@KafkaListener(topics = "inventory.events", groupId = "inventory-roundtrip-test")
