...
class ProblemTypeTest {
	...
	void toUri_withoutTrailingSlash() {
		assertThat(ProblemType.PAYMENT_NOT_FOUND.toUri("https://wastecoder.com/problems"))
				.hasToString("https://wastecoder.com/problems/payment-not-found");
	}
	...
	void exposesAttributes() {
		assertThat(ProblemType.PAYMENT_NOT_FOUND.status()).isEqualTo(HttpStatus.NOT_FOUND);
