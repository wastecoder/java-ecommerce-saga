...
class KafkaEventPublisherTest {
	...
	void publish_withinTransaction_defersSendUntilAfterCommit() {
		...
		try {
			publisher.publish(topic, orderId, "OrderCreated", Map.of("productId", "SKU-1", "quantity", 2));
