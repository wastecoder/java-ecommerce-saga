...
class ProblemTypeTest {
	...
	void toUri_withoutTrailingSlash() {
		assertThat(ProblemType.ORDER_NOT_FOUND.toUri("https://wastecoder.com/problems"))
				.hasToString("https://wastecoder.com/problems/order-not-found");
	}
	...
	void exposesAttributes() {
		assertThat(ProblemType.ORDER_NOT_FOUND.status()).isEqualTo(HttpStatus.NOT_FOUND);
